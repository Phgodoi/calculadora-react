...
const App = () => {
  ...
  const handleMultNumber = () => {
    //Função para multplicar (*) os valores
    if (firstNumber === "0") {
      setFirstNumber(String(currentNumber));
      setCurrentNumber("0");
      setOperation("X");
  ...
  const handleExpNumber = () => {
    //Função para fazer claculo exponencial (^)  dos valores
    if (firstNumber === "0") {
      setFirstNumber(String(currentNumber));
      setCurrentNumber("0");
      setOperation("^");
  ...
  const handlePercentNumber = () => {
    //Função para clacular valor percentual (%)  dos valores
    if (firstNumber === "0") {
      setFirstNumber(String(currentNumber));
      setCurrentNumber("0");
      setOperation("%");
    ...
    <Container>
      <Content>
        ...
        <Row>
          ...
          <Button variant="secundary" label={"^"} onClick={handleExpNumber} />
          <Button
            variant="secundary"
            label={"%"}
        ...
        <Row>
          ...
          <Button variant="secundary" label={"X"} onClick={handleMultNumber} />
        </Row>
        <Row>
          <Button label={"1"} onClick={() => handleAddNumber("1")} />
          <Button label={"2"} onClick={() => handleAddNumber("2")} />
          <Button label={"3"} onClick={() => handleAddNumber("3")} />
          <Button variant="secundary" label={"/"} onClick={handleDivNumber} />
        </Row>
        <Row>
